...
#' @param p lost follow-up ratio
#'
#' @return string
#' @export
#'
#' @examples
#' calcSampleSizeForRCT(alpha=0.05, gamma=0.80, piT=0.15, piC=0.2)
#' #tatol sample should be doubled
calcSampleSizeForRCT <- function(alpha, gamma, piT, piC, p = 0) {
  # if we estimate that 10% of the people are likely to be lost to follow-up, then p=0.1
